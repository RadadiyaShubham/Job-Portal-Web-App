import {
  ...
  const JobsCard = (props: any) => {
    ...
    return (
      <div className="bg-mine-shaft-900 p-4 m-2 w-80 sm-mx:w-full flex flex-col gap-4 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-1 text-xs text-mine-shaft-400 items-center">
            ...
            {timeAgo(props.postTime)} {props.postedDaysAgo}
          </div>
        </div>
